...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/zenodo_get-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/zenodo_get-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install zenodo_get
```
...
It is possible to list all of the versions of `zenodo_get` available on your platform:
...
```
pixi search zenodo_get --channel conda-forge
```
